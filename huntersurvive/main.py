...
SCREEN = pygame.display.set_mode((SCREEN_HEIGHT, SCREEN_WIDTH))
pygame.display.set_caption("hunter survive")
...
def play():
    ...
    OPTIONS_RECT = OPTIONS_TEXT.get_rect(center=(600,250))
    while True:
        ...
        if sta == 'End':
            ...
            SCORETEXT = get_font(45).render("score "+str(game_event.score), True, "Black")
            SCORErect = SCORETEXT.get_rect(center =(600,350))
...
def main_menu():
    ...
    while True:
        ...
        MENU_TEXT = get_font(70).render("HUNTER SURVIVE", True, "#b68f40")
        MENU_RECT = MENU_TEXT.get_rect(center=(640, 100))

        PLAY_BUTTON = Button(image=None, pos=(640, 300), 
                            text_input="PLAY", font=get_font(65), base_color="#FFFFFF", hovering_color="Black")
        OPTIONS_BUTTON = Button(image=None, pos=(640, 450), 
                            text_input="SCOREBOARD", font=get_font(65), base_color="#FFFFFF", hovering_color="Black")
        QUIT_BUTTON = Button(image=None, pos=(640, 600), 
                            text_input="QUIT", font=get_font(65), base_color="#FFFFFF", hovering_color="Black")
        NAMETEXT = get_font(14).render("65011017 SARANJIRAT ANGCHARUSILA", True, "Black")
        NAMErect = NAMETEXT.get_rect(midleft =(750,710))
