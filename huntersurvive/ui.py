...
def playing(game_event,screen,sta,user_text):
    if not game_event.event_status :
        ...
        resume = Button(image=None, pos=(600, 300), 
                        text_input="Resume", font=get_font(40), base_color="Black", hovering_color="Green")
        endgame = Button(image=None, pos=(600, 400), 
                        text_input="Endgame", font=get_font(40), base_color="Black", hovering_color="Red")
        ...
        if sta == 'Pause':
            ...
            endgame.changeColor(MENU_MOUSE_POS)
            endgame.update(screen)
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if resume.checkForInput(MENU_MOUSE_POS):
                    sta = 'Start'
                if endgame.checkForInput(MENU_MOUSE_POS):
                    sta = 'End'
        return sta
